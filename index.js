...
var HeaderTimeline = function (_React$Component) {
  ...
  function HeaderTimeline() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HeaderTimeline.__proto__ || Object.getPrototypeOf(HeaderTimeline)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      showTooltip: false
